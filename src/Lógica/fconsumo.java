...
public class fconsumo {
   ...
   public DefaultTableModel mostrar(String buscar){
       ...
       String [] titulos = {"ID","idreserva","idproducto","producto","cantidad","Precio Venta"};
   ...
   public boolean insertar (vconsumo dts){
       sSQL="insert into consumo (idreserva,idproducto,cantidad,precio_venta)" +
               "values (?,?,?,?)";
       try {
   ...
   public boolean editar (vconsumo dts){
       sSQL="update consumo set idreserva=?,idproducto=?,cantidad=?,precio_venta=?"+
               " where idconsumo=?";
