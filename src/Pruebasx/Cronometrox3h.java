 ...
 * @author JCarlos;
 */
public class Cronometrox3h extends javax.swing.JFrame {
    Sonido a= new Sonido();
    public Cronometrox3h() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cronometrox3h.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Cronometrox3h().setVisible(true);
            }
        });
    }
