 ...
 * @author JCarlos;
 */
public class Cronometrox5h extends javax.swing.JFrame {
    Sonido a= new Sonido();
    public Cronometrox5h() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cronometrox5h.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Cronometrox5h().setVisible(true);
            }
        });
    }
