 ...
 * @author JCarlos;
 */
public class Cronometroxh extends javax.swing.JFrame {
    Sonido a= new Sonido();
    public Cronometroxh() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cronometroxh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Cronometroxh().setVisible(true);
            }
        });
    }
